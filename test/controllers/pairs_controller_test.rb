...
class PairsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pair" do
    assert_difference('Pair.count') do
      post pairs_url, params: { pair: { partner_id: @pair.partner_id, user_id: @pair.user_id } }
    end
  ...
  test "should update pair" do
    patch pair_url(@pair), params: { pair: { partner_id: @pair.partner_id, user_id: @pair.user_id } }
